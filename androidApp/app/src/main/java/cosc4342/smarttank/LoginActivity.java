...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     */
    private static final String[] DUMMY_CREDENTIALS = new String[]{"cesar.salazar@gmail.com:password", "aaron.paul@gmail.com:password", "krishan.desai@gmail.com:password", "jason.morales@gmail.com:password"};
    /**
...
//    }
    ...
    public void signIn(){
        Intent startView = new Intent(this, ViewsPager.class);
